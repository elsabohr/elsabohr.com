$(document).ready(function() {
	...
	$('.img-box').click(function(e) {
		...
		slidesHtml = slidesHtml + '</div><nav class="slides-navigation"><a href="#" class="next"><i class="icon-circle-right"></i></a><a href="#" class="prev"><i class="icon-circle-left"></i></a></nav>';
